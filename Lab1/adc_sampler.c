...
#define OUTPUT_DATA "/home/pi/lab1/aadcData.bin" // path and filename to dump buffered ADC data
...
#define SPI_SS 13    // GPIO for slave select (BCM 8 aka GPIO 8 aka SPI_CE0).
#define CLK 4      // GPIO for SPI clock (BCM 11 aka GPIO 11 aka SPI_CLK).
